...
place11 = Place.create(name: "Death Star", place_type: "Other", description: " Welcome to the Dark Side", price_day: 2999, user: arthas, rating: 2)
place11.photo.attach(io: File.open("app/assets/images/deathstar.jpg"), filename: "deathstar.jpg", content_type: "image/jpg")

place12 = Place.create(name: "Wakanda", place_type: "Other", description: " Wakanda Forever!", price_day: 1000000, user: arthas, rating: 5)
place12.photo.attach(io: File.open("app/assets/images/wakanda.jpg"), filename: "wakanda.jpg", content_type: "image/jpg")

place13 = Place.create(name: "Pirates of The Caribbean Ship", place_type: "Other", description: " Spend some time with Captain Jack Sparrow.", price_day: 4000, user: arthas, rating: 4)
place13.photo.attach(io: File.open("app/assets/images/pirates.jpg"), filename: "pirates.jpg", content_type: "image/jpg")

place14 = Place.create(name: "X-Mansion", place_type: "House", description: " The mansion of Charles Xavier. If you're lucky you might meet Wolverine!", price_day: 3000, user: cersei, rating: 4)
place14.photo.attach(io: File.open("app/assets/images/x-mansion.jpg"), filename: "x-mansion.jpg", content_type: "image/jpg")

place16 = Place.create(name: "Flinstones House", place_type: "House", description: " Jabadabadoo", price_day: 1799, user: arthas, rating: 3)
place16.photo.attach(io: File.open("app/assets/images/flinstones.jpg"), filename: "flinstones.jpg", content_type: "image/jpg")

place17 = Place.create(name: "Walking Dead Jail", place_type: "Prison", description: " For thrillseekers only!", price_day: 6999, user: arthas, rating: 5)
place17.photo.attach(io: File.open("app/assets/images/walkingdead.jpg"), filename: "walkingdead.jpg", content_type: "image/jpg")

place18 = Place.create(name: "Up House", place_type: "House", description: " For a cozy stay with your loved ones. Balloons for takeoff included!", price_day: 4999, user: cersei, rating: 2)
place18.photo.attach(io: File.open("app/assets/images/Up-House.jpg"), filename: "Up-House.jpg", content_type: "image/jpg")

place19 = Place.create(name: "The Shire", place_type: "House", description: " Peacefull place with a lot of small people around", price_day: 6999, user: cersei, rating: 2)
